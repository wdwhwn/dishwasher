...
public class WechatUtil {
    ...
    // 微信appid 1
   static String appid = "wx778f313eff0f980b";
    // 微信secret
    static String secret = "910415b15c96d7268cc1ee899f5fc8cd";
    // 初始化access_token
    static String access_token = "jingzhun";
    //    商户id
    static String mchId = "1512803161";
    //    商户key
    static  String paternerKey = "jingzhunruanjiankejiyouxiangong0";
    /**
     * 充值客户端类型--微信公众号
     */
    ...
    private static Map<Object, Object> buildRequsetMapParam(String out_trade_no, BigDecimal bdOrderMoney, BigDecimal bdRefundMoney) {
        ...
        //订单总金额，单位为分，只能为整数
        params.put("total_fee", bdOrderMoney);
        //退款总金额，订单总金额，单位为分，只能为整数
        params.put("refund_fee",bdRefundMoney);
        //操作员帐号, 默认为商户号
        params.put("op_user_id", mchId);
        //签名前必须要参数全部写在前面
        params.put("sign", arraySign(params,paternerKey ));
        return params;
    }
    ...
    public static String requestOnce(final String url, String data) throws Exception {
        ...
        httpPost.addHeader("User-Agent", "wxpay sdk java v1.0 " + "1512803161");
